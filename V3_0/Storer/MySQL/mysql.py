...
def createTable(tableName, drop=True):
	...
	query("""CREATE TABLE `%s`(
	   ...
	   `学习方式` VARCHAR(1000),
	   `拟招生人数` VARCHAR(1000), `考试范围URL` VARCHAR(660) unique,
